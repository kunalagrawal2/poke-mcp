...
async function testPokemonMCPServer() {
  ...
  try {
    ...
    try {
      ...
      console.log((randomPokemon.content as any[])[0].text);
      console.log();
    } catch (error) {
    ...
    try {
      ...
      console.log((kantoPokemon.content as any[])[0].text);
      console.log();
    } catch (error) {
    ...
    try {
      ...
      console.log((firePokemon.content as any[])[0].text);
      console.log();
    } catch (error) {
    ...
    try {
      ...
      console.log((invalidRegion.content as any[])[0].text);
      console.log();
    } catch (error) {
    ...
    try {
      ...
      console.log("✅ Error handling result:");
      console.log((invalidType.content as any[])[0].text);
      console.log();
    } catch (error) {
